            ...
            <div class="row">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($result > 0) {
                        ...
                        echo "<script>window.location.assign('add_assignment.php?msg');</script>";
                    } else {
                ...
                <div class="col-lg-12 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="marks" class="form-control" id="marks" aria-describedby="marks" required>
                        </div>
